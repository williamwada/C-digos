...
'-- EPOS
Set Eshell = CreateObject("WScript.Shell")
Eshell.CurrentDirectory = "Y:\Daily opreation\WebEpos\auto\scripts"
errorCode = Eshell.Run("2_Load_and_generate_the_report.cmd",1,true)
If errorCode <> 0 Then
	Wscript.Echo "Error: "&errorCode
else
	Wscript.Echo "Sucessful Epos run!" 
End If

'-- 7CARD
Set shell = CreateObject("WScript.Shell")
shell.CurrentDirectory = "Z:\Daily opreation\DAM\auto"
errorCode = shell.Run("2_Load_and_generate_the_report.cmd",1,true)
If errorCode <> 0 Then
	Wscript.Echo "Error: "&errorCode
else
	Wscript.Echo "Sucessful 7Card run!" 
End If
