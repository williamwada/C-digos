...
Sub SendEmail(ToAddress, Subject, Text)
    ...
    With Flds
        ...
        .Item("http://schemas.microsoft.com/cdo/configuration/sendusername") = "williampswada@gmail.com"
        .Item("http://schemas.microsoft.com/cdo/configuration/sendpassword") = "Jetstream110910"
