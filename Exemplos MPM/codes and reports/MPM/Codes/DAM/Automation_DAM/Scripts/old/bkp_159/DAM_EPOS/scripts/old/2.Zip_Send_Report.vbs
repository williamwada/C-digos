...
'--EPOS_F13
 ...
 srcFile = "D:\EPOS_PRD\DATA_AREA\IN\DAM\F13\HISTORIC\AF13_EPOS_WEB_SALES_"&dateFinal&".xls"
...
'--EPOS_Report
 ...
 srcFile = "D:\EPOS_PRD\REPORTS\DAM_Reports\EPOS_WEB_Sales_"&dateFinal&"\EPOS_WEB_Sales_"&dateFinal&".xls"
...
'Delete the file after zip
 Set objR = CreateObject("Scripting.FileSystemObject")
 objR.DeleteFile(srcFile),DeleteReadOnly
